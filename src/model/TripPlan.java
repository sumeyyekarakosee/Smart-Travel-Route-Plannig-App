...
public class TripPlan {
    ...
    // Girdi saat bazındadır; içeride dakikaya çevrilir.
    public void calculateEstimatedDays(int dailyHours) {
        if (dailyHours <= 0) {
            estimatedDays = 1;
            return;
        }
        ...
        estimatedDays = (int) Math.ceil((double) totalTime / dailyLimitMinutes);
    }

...
public class RoutePlanner {
    ...
    /**
     * UI ve test tarafında lokasyonları tema bazında filtreler.
     * İlk 20 kayıt ilçe / semt, geri kalan kayıtlar tarihi / turistik olarak kabul edilir.
     */
    public List<Integer> filterByTheme(List<Integer> locationIds, TripTheme theme) {
        ...
        if (theme == null || theme == TripTheme.ALL) {
        ...
        for (Integer id : locationIds) {
            ...
            boolean isDistrict = id <= 20;
            boolean isHistorical = id > 20;

            if (theme == TripTheme.DISTRICTS && isDistrict) {
                filtered.add(id);
            } else if (theme == TripTheme.HISTORICAL && isHistorical) {
                filtered.add(id);
            }
        }
